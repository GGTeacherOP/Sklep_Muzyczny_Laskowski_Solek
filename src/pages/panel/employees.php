...
<div class="admin-filters">
  ...
  <div class="dropdown">
    ...
    <ul class="dropdown-menu" id="roleDropdown">
      <li><a href="#" class="dropdown-item" onclick="selectRole('', 'Wszystkie stanowiska')">Wszystkie stanowiska</a>
      </li>
  ...
  <div class="modal-content">
    ...
    <form method="POST" onsubmit="return validateForm()">
      ...
      <div class="form-group">
        ...
        <input type="text" id="identyfikator" name="identyfikator" class="form-input" required pattern="[A-Za-z0-9]+"
      ...
      <div class="form-group">
        ...
        <input type="password" id="password_confirm" class="form-input" minlength="8">
      </div>
